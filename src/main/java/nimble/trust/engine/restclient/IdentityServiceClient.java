 ...
 */
@FeignClient(name = "identity-service", url = "${nimble.identity.url:}",fallback = IdentityServiceClientFallBack.class)
public interface IdentityServiceClient {
	...
	Response getProfileCompleteness(@PathVariable("partyId") String partyId);
